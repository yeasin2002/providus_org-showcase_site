...
export const CTAButton = ({ text }: { text: string }) => {
  return (
    <button className="bg-[#C79C44] hover:bg-yellow-500 text-white font-semibold px-6 py-2 rounded-full inline-flex items-center gap-4 transition-all hover:scale-90">
      <span>{text}</span>
